...
class WatsonxAI:
    GRANITE_3_1_8B_CODE_INSTRUCT = " ibm/granite-3.1-8b-instruct"
    ...
    project_id = "17004316-fd56-4c0d-a24f-3f1b714a7276"
    api_key = "_vStH-fEI5TcZ0UYFiTliNYSkKHzFgLFdAHjRNY6qNx3"
    access_token = "p-2+bZ6doCqqc1eyuGf3x38bsg==;8EvDYGZzDd+QxT6TGcwgfg==:qAgpQrV3s1FYAe5kDl4W3PpU4Az6Ts/Dzc6cz0P1BedTTUfz8Nm23L9+hYTybEhXEC8/YFrMv942qVhQkYL1PN6RPFig7zf+zg=="
    ibm_cloud_iam_url = "https://us-south.ml.cloud.ibm.com"
    ...
    def connect(self):
        ...
        self.ibm_cloud_iam_url = os.getenv("IAM_IBM_CLOUD_URL")
